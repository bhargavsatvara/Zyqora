...
export const footerSocial = [
    ...
    {
        icon:FiDribbble,
        link:'https://dribbble.com/Zyqora'
    },
    {
        icon:FiLinkedin,
        link:'http://linkedin.com/company/Zyqora'
    },
    {
        icon:FiFacebook,
        link:'https://www.facebook.com/Zyqora'
    },
    {
        icon:FiInstagram,
        link:'https://www.instagram.com/Zyqora'
    },
    {
        icon:FiTwitter,
        link:'https://twitter.com/Zyqora'
    },
    {
        icon:FiMail,
        link:'mailto:support@Zyqora.in'
    },
]
...
export const paymentCart = [
    payament1,payament2,payament3,payament4,payament5
]
...
export const clientData = [
    {
        ...
        name:'Christa Smith',
        possition:'Manager',
        desc:'" Zyqora made the processes so easy. Zyqora instantly increased the amount of interest and ultimately saved us over $10,000. "'
    },
    {
        image:client2,
        name:'Christa Smith',
        possition:'Manager',
        desc:'" I highly recommend Zyqora as the new way to sell your home "by owner". My home sold in 24 hours for the asking price. Best $400 you could spend to sell your home. "'
    },
    {
        image:client3,
        name:'Christa Smith',
    ...
    },
    {
        ...
        name:'Christa Smith',
        possition:'Manager',
        desc:'" Zyqora made selling my home easy and stress free. They went above and beyond what is expected.. "'
    },
    {
        image:client6,
        name:'Christa Smith',
        possition:'Manager',
        desc:'" Zyqora is fair priced, quick to respond, and easy to use. I highly recommend their services! "'
    },
]
...
export const brand = [
    ...
    },
    {
        id:3,
        name:[
            'Cherokee','Chiara Ferragni','Daniele Alessandrini','Daniele Fiesoli','Demdaco','Department Five','Design Toscano','Designq','Desigual','Dolce Vita','Dondup','Dorothee Schumacher','Doucals','Dr. Martens','Logitech','Zyqora',
        ]
    },
]
...
export const userSocial = [
    {
        ...
        desc:'Add your Twitter username (e.g. Bhargav Satvara).'
    },
    {
        icon:FiFacebook,
        title:'Facebook',
        placeholder:'Facebook Profile Name',
        desc:'Add your Facebook username (e.g. Bhargav Satvara).'
    },
    {
        icon:FiInstagram,
        title:'Instagram',
        placeholder:'Instagram Profile Name',
        desc:'Add your Instagram username (e.g. Bhargav Satvara).'
    },
    {
        icon:FiLinkedin,
        title:'Linkedin',
        placeholder:'Linkedin Profile Name',
        desc:'Add your Linkedin username (e.g. Bhargav Satvara).'
    },
    {
        icon:FiYoutube,
        title:'Youtube',
...
export const guidenceData = [
    ...
    {
        name:'Your listings',
        features:['Updating your listing','Neighbourhoods','Listing photos & photography','Zyqora Plus','API-connected software']
    },
    {
    ...
    },
    {
        ...
        features:['Zyqora safely','Zyqora Experiences and Adventures','Changing a reservation','Cancelling a reservation','Long-term reservations']
    },
    {
...
export const faqData = [
    ...
    {
        id:2,
        title:'Do I need a designer to use Zyqora ?',
        desc:'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.'
    },
    {
        id:3,

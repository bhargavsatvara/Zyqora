                ...
                <div className="grid md:grid-cols-2 grid-cols-1 mt-8 gap-6" role="region" aria-label="FAQ Blocks">
                    <div className="flex">
                        ...
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold">How our <span className="text-orange-500">Zyqora</span> work ?</h5>
                    ...
                    <div className="flex">
                        <FiHelpCircle className="fea icon-ex-md text-orange-500 me-3 size-5 mt-1"></FiHelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold"> Is <span className="text-orange-500">Zyqora</span> safer to use with my account ?</h5>

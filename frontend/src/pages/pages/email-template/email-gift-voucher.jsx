        ...
        <div style={{margin: "24px auto"}}>
            <table cellpadding="0" cellspacing="0" style={{fontFamily: 'DM Sans, sans-serif' , fontSize: '16px', fontWeight: '400', width: '600px', border: 'none', margin: '0 auto', borderRadius: '6px', overflow: 'hidden', backgroundColor: '#fff', boxShadow:' 0 0 3px rgba(60, 72, 88, 0.15)'}}>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{padding: '16px 16px 0'}}>
                            <span style={{padding: '16px', borderRadius: '5px', display: 'block', boxShadow: '0 0 3px rgba(60, 72, 88, 0.15)', textAlign: 'center', backgroundColor: '#f8fafc'}}>
                                ...
                                <Link to="#" style={{padding: '8px 20px', outline: 'none', textDecoration: 'none', fontSize: '15px', display: 'inline-block', letterSpacing:' 0.5px', transition: 'all 0.3s', fontWeight: '500', borderRadius: '6px', backgroundColor: '#f97316', border: '1px solid #f97316', color: '#fff'}}>Claim Now!</Link>
                    ...
                    <tr>
                        <td style={{padding: '16px 16px 0'}}>
                            <p style={{margin: '0', color: '#94a3b8'}}>If you have any queries please contact us via our customer support <Link to="" style={{color: '#ea580c'}}>contact@Zyqora.com</Link> </p>
                        </td>
                    </tr>

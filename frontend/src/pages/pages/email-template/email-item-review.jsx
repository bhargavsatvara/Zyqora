...
import product1 from '../../../assets/images/shop/luxurious-bag.jpg'

export  default function EmailItemReviw(){
    return(
                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{padding: '16px 16px 0'}}>
                            <table>
                                <tr>
                                    <td>
                                        <img src={product1} width="200px" style={{borderRadius: '5px', boxShadow: '0 0 3px rgba(60, 72, 88, 0.15)'}} alt=""/>
                    ...
                    <tr>
                        <td style={{padding: '16px', color: '#94a3b8'}}>
                            ...
                            <Link to="#" style={{padding: '8px 20px', outline: 'none', textDecoration:' none', fontSize: '15px', display: 'inline-block', letterSpacing: '0.5px', transition: 'all 0.3s', fontWeight: '500', borderRadius: '6px', backgroundColor:' #f97316', border:' 1px solid #f97316', color: '#ffffff'}}>Send Now</Link>
                        </td>
                    </tr>

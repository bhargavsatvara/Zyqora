...
export default function Privacy(){
    return(
        ...
        <section className="relative md:py-24 py-16" role="main">
            <div className="container relative" role="region" aria-label="Privacy Content">
                <div className="md:flex justify-center">
                    <div className="md:w-3/4">
                        <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                            ...
                            <div className="mt-8">
                                <Link to="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-orange-500 hover:bg-orange-600 border-orange-500 hover:border-orange-600 text-white rounded-md">Print</Link>
                            </div>
                        </div>
                    </div>
                </div>

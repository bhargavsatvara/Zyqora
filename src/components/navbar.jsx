            ...
            <div className="container relative">
                        ...
                        {userManu && (
                            <div className="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-48 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-700">
                                <ul className="py-2 text-start">
                                    ...
                                    <li className='ms-0'>
                                        <Link to="#" className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-orange-500 dark:hover:text-white"><FiUser className="h-4 w-4 me-2"></FiUser>Account</Link>
                                    </li>
                                    <li className='ms-0'>
                                        <Link to="#" className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-orange-500 dark:hover:text-white"><FiHelpCircle className="h-4 w-4 me-2"></FiHelpCircle>Helpcenter</Link>
                                    </li>
                                    <li className='ms-0'>
                                        <Link to="#" className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-orange-500 dark:hover:text-white"><FiSettings className="h-4 w-4 me-2"></FiSettings>Settings</Link>
                                    </li>
                ...
                <div id="navigation" style={{display: isToggle === true ? 'block' : 'none'}}>
                    <ul className={`navigation-menu ${navlight === true ? 'nav-light' : ''}`}>
                            ...
                            <ul className={`submenu megamenu ${['/product-item'].includes(subManu) ? 'open' : ''}`}>
                                <li className='ms-0'>
                                    <ul>    
                                        ...
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">T-Shirts</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Shirt</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Jeans</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Hoodies & Sweatshirts</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Shorts</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Jackets</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Boxers & Briefs</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Sport Jackets & Windbreakers</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Casual Shirts</Link></li>
                                    </ul>
                                </li>
                                ...
                                <li className='ms-0'>
                                    <ul>
                                        ...
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Jeans</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Hoodies & Sweatshirts</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Casual Dresses</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Formal & Evening Gowns</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Pants & Trousers</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Skirts (Mini, Midi, Maxi)</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Jackets</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Tracksuits & Joggers</Link></li>
                                    </ul>
                                </li>
                                ...
                                <li className='ms-0'>
                                    <ul>
                                        ...
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">T-Shirts</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Jeans</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Polo Shirts</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Jackets</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Bodysuit</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Lounge Sets</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Rompers & Jumpsuits</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Coats & Parkas</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Shorts</Link></li>
                                    </ul>
                                </li>
                                ...
                                <li className='ms-0'>
                                    <ul>
                                        ...
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Smart Watch</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Shoes</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Socks</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Hat</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Sunglasses</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Belt</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Backpacks & Lunch Bags</Link></li>
                                        <li className='ms-0'><Link to="#!" className="sub-menu-item">Slippers</Link></li>
                                    </ul>
                                </li>
                        
                                <li className='ms-0'>
                                    <ul>
                                        <li className="megamenu-head"><img src={ctaImg} alt=""/></li>

                                        <li className="text-center"><Link to="#!" className="py-2 px-5 inline-block font-medium tracking-wide align-middle duration-500 text-base text-center bg-orange-500/10 text-orange-500 rounded-md me-2 mt-2"><i className="mdi mdi-cart-outline"></i> Shop Now</Link></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className={`${manu === '/sale' ? 'active' : ''}`}><Link to="#" className="sub-menu-item">Sale</Link></li>
                        <li className={`${manu === '/about-us' ? 'active' : ''}`}><Link to="#" className="sub-menu-item">About Us</Link></li>


                        <li className={`${manu === '/contact' ? 'active' : ''}`}><Link to="#" className="sub-menu-item">Contact Us</Link></li>
                    </ul>
                </div>
            </div>
        </nav>

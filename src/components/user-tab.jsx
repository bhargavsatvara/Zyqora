...
import {FiAirplay, FiEdit, FiCreditCard, FiFileText, FiSettings, FiLogOut} from '../assets/icons/vander'
                    ...
                    <div className="border-t border-gray-100 dark:border-gray-700">
                        <ul className="list-none sidebar-nav mb-0 pb-0" id="navmenu-nav">
                            ...
                            <li className={`navbar-item account-menu ms-0 ${current === '/lock-screen' ? 'active' : '' }`}>
                                <Link to="/login" className="navbar-link text-slate-400 flex items-center py-2 rounded">

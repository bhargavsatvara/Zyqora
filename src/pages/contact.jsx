        ...
        <div className="container-fluid relative mt-20">
            <div className="grid grid-cols-1">
                <div className="w-full leading-[0] border-0">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5769.2324575574985!2d-79.75088682399527!3d43.69774127109995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b15c0f887afd3%3A0x8894f6babedd13eb!2sFashioniq%20Outlet%20-%20Brampton!5e0!3m2!1sen!2sca!4v1750617502291!5m2!1sen!2sca" style={{border:'0'}} title="Zyqora" className="w-full h-[500px]" allowFullScreen></iframe>
                </div>
            </div>
        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-6">
                    ...
                    <div className="text-center px-6">
                        ...
                        <div className="content mt-7">
                            ...
                            <p className="text-slate-400 mt-3">C/54 Northwest Freeway, Suite 558, <br/> Houston, Canada 485</p>
        ...
        {modal && (
            <div className="w-full h-screen bg-slate-900/80 fixed top-0 left-0 bottom-0 right-0 z-999 flex items-center justify-center">
                <div className="w-full h-full px-5 md:px-40 md-py-20 py-5">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5769.2324575574985!2d-79.75088682399527!3d43.69774127109995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b15c0f887afd3%3A0x8894f6babedd13eb!2sFashioniq%20Outlet%20-%20Brampton!5e0!3m2!1sen!2sca!4v1750617502291!5m2!1sen!2sca" width="100%" height="100%" title="myfram"  loading="lazy"></iframe>
                </div>

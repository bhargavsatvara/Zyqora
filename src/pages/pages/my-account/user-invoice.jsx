                                ...
                                <div className="md:flex justify-between">
                                    <div>
                                        ...
                                        <div className="flex mt-4">
                                            ...
                                            <Link to="Zyqora" target="_blank" className="text-orange-500 dark:text-white font-medium">Zyqora</Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 md:mt-0 md:w-56">
                                        ...
                                        <ul className="list-none">
                                            ...
                                            <li className="flex mt-3 ms-0">
                                                ...
                                                <Link to="mailto:contact@example.com" className="text-slate-400">info@zyqora.com</Link>
                                            </li>
                                ...
                                <div className="md:flex justify-between">
                                    ...
                                    <div className="mt-4 md:mt-0">
                                        <div className="text-slate-400 text-center md:text-end">
                                            <h6 className="mb-0"><Link to="/page-terms" target="_blank" className="text-orange-500">Terms & Conditions</Link></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
